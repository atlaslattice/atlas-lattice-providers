...
class OpenAIProvider(ProviderContract):
    ...
    def capabilities(self) -> Dict[str, Any]:
        return {
            ...
            "supports_structured_claims": True,
            "supports_tool_passports": True,
            "supports_trace_receipts": True,
            "supports_eval_exports": True,
            "requires_openai_api_key_for_live": True,
        }
