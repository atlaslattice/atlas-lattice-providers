...
This dependency-light module exports dictionaries that can be consumed by a local
Agents SDK runner, Codex task, or MCP bridge without forcing CI to install extra
runtime packages.
"""
...
def build_agent_manifest(name: str, instructions: str, tools: Optional[List[Dict[str, Any]]] = None, handoffs: Optional[List[str]] = None) -> Dict[str, Any]:
    return {"name": name, "instructions": instructions, "tools": tools or [], "handoffs": handoffs or [], "guardrails": ["human_review_for_write_admin_destructive", "claimpacket_validation", "goldentrace_receipts"], "metadata": {"lattice_routes": True, "grok_leads": True}}
